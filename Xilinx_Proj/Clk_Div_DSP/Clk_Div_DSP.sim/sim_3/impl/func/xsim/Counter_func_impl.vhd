...
-- Date        : Sat Jan  9 10:14:32 2021
-- Host        : Gebruiker-PC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/X_projects/Cnt_v1/Cnt_v1.sim/sim_3/impl/func/xsim/Counter_func_impl.vhd
-- Design      : Counter
...
architecture STRUCTURE of Enable is
  ...
  attribute \PinAttr:I2:HOLD_DETOUR\ of \Enable.cnt[1]_i_1\ : label is 188;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Enable.cnt[1]_i_1\ : label is "soft_lutpair0";
  attribute \PinAttr:I1:HOLD_DETOUR\ : integer;
  attribute \PinAttr:I1:HOLD_DETOUR\ of \Enable.cnt[2]_i_1\ : label is 188;
  attribute SOFT_HLUTNM of \Enable.cnt[2]_i_1\ : label is "soft_lutpair0";
  attribute OPT_MODIFIED : string;
  attribute OPT_MODIFIED of \Enable.tr_reg\ : label is "RETARGET";
begin
...
\bl.DSP48E_2_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\bl.DSP48E_2_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\bl.DSP48E_2_i_2\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \bl.DSP48E_2_i_4_n_0\,
      I2 => \bl.DSP48E_2_i_5_n_0\,
      I3 => \bl.DSP48E_2_i_6_n_0\,
...
\bl.DSP48E_2_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\bl.DSP48E_2_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => CNTR_OUT(0),
      I2 => \bl.DSP48E_2_i_8_n_0\,
      I3 => \bl.DSP48E_2_i_9_n_0\,
      I4 => \bl.DSP48E_2_i_10_n_0\,
      I5 => \bl.DSP48E_2_i_11_n_0\,
      O => \bl.DSP48E_2_i_6_n_0\
    );
\bl.DSP48E_2_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\bl.DSP48E_2_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\bl.DSP48E_2_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
ck_io0_OBUF_inst_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity Counter is
  ...
  attribute ECO_CHECKSUM of Counter : entity is "f5b39295";
end Counter;
