...
HD_PWD='C:/Github/FPGA-Elec-Design/Xilinx_Proj/PS/PS.runs/PS_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_rst_ps7_0_50M_0.tcl
