create_property DEVICE cell -type string
create_property RESET_UPON_TC cell -type string
create_property COUNT_BY cell -type string
create_property TC_VALUE cell -type string
create_property WIDTH_DATA cell -type int
...
create_clock -period 1000.000 -name sys_clk_pin -waveform {0.000 500.000} -add [get_ports iCLK]
...
set_property DEVICE SERIES7 [get_cells cCOUNTER_TC]
set_property RESET_UPON_TC TRUE [get_cells cCOUNTER_TC]
set_property COUNT_BY 1'b1 [get_cells cCOUNTER_TC]
set_property TC_VALUE 16 [get_cells cCOUNTER_TC]
set_property WIDTH_DATA 1 [get_cells cCOUNTER_TC]
set_property MREG 0 [get_cells cCOUNTER_TC/v5.DSP48E_1]
set_property SIM_DEVICE 7SERIES [get_cells cBUFGCE]
